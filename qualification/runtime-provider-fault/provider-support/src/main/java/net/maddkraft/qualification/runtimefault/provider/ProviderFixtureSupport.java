package net.maddkraft.qualification.runtimefault.provider;
...
public final class ProviderFixtureSupport {
    private ProviderFixtureSupport() {
    }
    ...
    public static ProviderMetricDefinition countMetric(String id, String unit) {
        return new ProviderMetricDefinition(new MetricId(id), MetricValueType.COUNT,
                ...
                "qualification.metric." + id, "qualification.metric." + id + ".description", unit, "authoritative");
    }
