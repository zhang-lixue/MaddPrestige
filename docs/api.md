...
MaddPrestige `2.0.1` uses owner-frozen compatibility baseline `2.x-stable-1`: 46 Bukkit-free Stable SDK types
...
The Maven coordinate is `net.maddkraft:maddprestige-api:2.0.1`. Experimental, Internal/Should Not Be Public,
...
No separate external nullness-annotation dependency is required for 2.0.1. Javadocs, explicit `Optional`,
