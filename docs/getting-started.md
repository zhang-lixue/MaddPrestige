...
- the MaddPrestige `2.0.0-rc.2` candidate and its published checksum
...
2. Put the plugin in `plugins/MaddPrestige.jar`; add the exact LuckPerms JAR only if the candidate configuration
