...
[`examples/provider-sdk`](../examples/provider-sdk). That example is API documentation; accepted release evidence separately proves the independent multi-provider and
