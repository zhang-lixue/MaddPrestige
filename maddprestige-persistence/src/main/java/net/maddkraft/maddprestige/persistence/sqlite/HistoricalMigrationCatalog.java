...
/** Immutable checksum-bearing definitions for already released schema versions. */
final class HistoricalMigrationCatalog {
    private HistoricalMigrationCatalog() {
    }
    ...
    public static List<Migration> throughVersionTwo() {
        ArrayList<Migration> migrations = new ArrayList<>(throughVersionOne());
    ...
    public static List<Migration> throughVersionThree() {
        ArrayList<Migration> migrations = new ArrayList<>(throughVersionTwo());
    ...
    public static List<Migration> throughVersionFive() {
        ArrayList<Migration> migrations = new ArrayList<>(throughVersionThree());
    ...
    public static List<Migration> throughVersionTen() {
        ArrayList<Migration> migrations = new ArrayList<>(throughVersionFive());
    ...
    /** Version 11 preserves the atomic stage+Prestige invariant for populated pre-Prestige databases. */
    public static List<Migration> throughVersionEleven() {
        ArrayList<Migration> migrations = new ArrayList<>(throughVersionTen());
    ...
    /** Version 12 archives stage-era authority and initializes the independent numeric model at Prestige zero. */
    public static List<Migration> current() {
        ArrayList<Migration> migrations = new ArrayList<>(throughVersionEleven());
