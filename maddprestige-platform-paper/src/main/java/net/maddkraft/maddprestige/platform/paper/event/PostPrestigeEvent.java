...
/**
 * Immutable Paper-server-thread notification fired after a durable terminal Prestige outcome and before the caller's
 * completion stage resolves. Listener failure is isolated and cannot change the durable result.
 */
@Stable
public final class PostPrestigeEvent extends Event {
     ...
     */
    public PostPrestigeEvent(OperationEventSnapshot snapshot) {
        super(false);
