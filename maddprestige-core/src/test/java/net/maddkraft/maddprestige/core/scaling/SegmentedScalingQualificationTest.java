...
import net.maddkraft.maddprestige.core.config.lifecycle.PrestigeValueScalingConfiguration;
...
class SegmentedScalingQualificationTest {
    @Test
    ...
    void compilerAcceptsOpenEndedSegmentsAndRejectsGapsAndIncompleteManualRanges() {
        var parsed = ProgressionConfigurationCompiler.segmentedScaling(List.of(Map.of(
                "start-prestige", 1,
